            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-1">
                    <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight tracking-tighter uppercase italic">
                        Asset <span className="text-blue-500">Intelligence</span>
                    </h1>
                ...
                <div className="xl:col-span-2 space-y-10">
                    ...
                    <div id="institutional-queue" className="bg-white rounded-[40px] shadow-sm border border-slate-100 overflow-hidden scroll-mt-6">
                        <div className="p-8 border-b border-slate-50 flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 uppercase italic">Institutional <span className="text-blue-600">Queue</span></h2>
                                <div className="flex items-center gap-6 mt-4">
                                    ...
                                    >
                                        ...
                                        {activeTab === "SERVICE" && <div className="absolute bottom-0 left-0 w-full h-1 bg-blue-600 rounded-full" />}
                                    </button>
                                    <button
                                    ...
                                    >
                                        ...
                                        {activeTab === "ACCOUNT" && <div className="absolute bottom-0 left-0 w-full h-1 bg-blue-600 rounded-full" />}
                                    </button>
                                    <button
                                        onClick={() => setActiveTab("HOD_DIRECTORY")}
                                        className={cn(
                                            "text-[10px] font-black uppercase tracking-[0.2em] pb-2 transition-all relative",
                                            activeTab === "HOD_DIRECTORY" ? "text-blue-600" : "text-slate-400 hover:text-slate-600"
                                        )}
                                    >
                                        HOD Directory
                                        ...
                                        {activeTab === "HOD_DIRECTORY" && <div className="absolute bottom-0 left-0 w-full h-1 bg-blue-600 rounded-full" />}
                                    </button>
                                </div>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="relative hidden md:block">
                                    ...
                                    <input
                                        ...
                                        className="pl-10 pr-4 py-3 bg-slate-50 border-none rounded-2xl text-xs w-64 focus:ring-2 focus:ring-blue-500 font-bold"
                                        value={searchQuery}
                        ...
                        {searchResults.length > 0 && searchQuery && (
                            <div className="p-8 bg-blue-50/50 border-b border-blue-100">
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-[10px] font-black uppercase text-blue-600 tracking-widest">Global Asset Locator</h3>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {searchResults.map(asset => (
                                        <div key={asset.id} className="p-5 bg-white rounded-3xl border border-blue-100 flex items-center justify-between group hover:border-blue-300 transition-all">
                                            <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <p className="text-[9px] text-blue-500 font-black uppercase tracking-wider">{asset.department.code} • {asset.lab?.code || 'UNALLOCATED'}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                                        ...
                                        <div key={hod.id} className="p-8 hover:bg-slate-50/50 transition-all group">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-5">
                                                    <div className="h-14 w-14 bg-blue-50 rounded-2xl flex items-center justify-center font-black text-blue-600 text-xl border border-blue-100">
                                                        {hod.name.charAt(0)}
                                                    </div>
                                                    <div>
                                                        <h4 className="text-lg font-black text-slate-900 group-hover:text-blue-600 transition-colors uppercase tracking-tight">{hod.name}</h4>
                                    ...
                                    <div key={req.id} className="p-8 hover:bg-slate-50/50 transition-all group">
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                            <div className="flex items-start gap-5">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2 mb-1">
                                                        <span className="text-[10px] font-black text-blue-600 uppercase tracking-widest">{req.type.replace('_', ' ')}</span>
                                                    ...
                                                    <h4 className="text-xl font-black text-slate-900 group-hover:text-blue-600 transition-colors uppercase tracking-tight">{req.title}</h4>
                                            ...
                                            <button
                                                ...
                                                className="flex items-center gap-2 px-8 py-4 bg-blue-600 text-white font-black text-xs uppercase tracking-widest rounded-2xl hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-200 transition-all"
                                            >
                                                Review & Act
                        ...
                        <div className="p-8 bg-slate-50/50 text-center border-t border-slate-100">
                            <button
                                ...
                                className="text-xs font-black text-blue-600 hover:text-blue-700 uppercase tracking-[0.2em] inline-flex items-center gap-3"
                            >
                ...
                <div className="space-y-10">
                    <div className="bg-white p-8 rounded-[40px] shadow-sm border border-slate-100">
                        ...
                        <div className="space-y-4">
                            {[
                                { label: "Manage Departments", icon: Building2, color: "text-purple-600", bg: "bg-purple-50", href: "/departments" },
                                { label: "Allocate New Lab", icon: Shield, color: "text-blue-600", bg: "bg-blue-50", href: "/labs" },
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-between p-6 bg-white border border-slate-100 rounded-3xl hover:border-blue-200 hover:bg-blue-50/20 group transition-all"
                                >
                                    <div className="flex items-center gap-4">
                                        <div className={`p-4 rounded-2xl ${action.bg} transition-transform group-hover:rotate-12`}>
                                            <action.icon className={`h-6 w-6 ${action.color}`} />
                                        </div>
                                        <span className="font-black text-slate-700 group-hover:text-blue-700 transition-colors uppercase text-[11px] tracking-widest">{action.label}</span>
                                    </div>
                    ...
                    <div className="space-y-8">
                        <div className="p-8 bg-slate-50 rounded-[40px] border border-slate-100 shadow-inner">
                            <div className="flex items-center gap-2 mb-3">
                                <span className="text-[10px] font-black text-blue-600 bg-blue-100 px-3 py-1 rounded-full uppercase tracking-widest">{selectedRequest.type.replace('_', ' ')}</span>
                        ...
                        <div className="space-y-8">
                            <div className="space-y-3">
                                ...
                                <textarea
                                    ...
                                    className="w-full p-8 bg-slate-50 rounded-[32px] border-none focus:ring-2 focus:ring-blue-500 font-bold text-slate-700 shadow-inner"
                                    value={remarks}
                            ...
                            <div className="space-y-3">
                                ...
                                <select
                                    className="w-full p-6 bg-slate-50 rounded-[24px] border-none focus:ring-2 focus:ring-blue-500 font-black text-xs text-slate-700 shadow-inner uppercase tracking-widest"
                            ...
                            <div className="grid grid-cols-2 gap-6 pt-4">
                                ...
                                <button
                                    ...
                                    disabled={processingRequest}
                                    className="flex items-center justify-center gap-3 py-6 bg-blue-600 text-white font-black text-[10px] uppercase tracking-[0.3em] rounded-[32px] hover:bg-blue-700 shadow-2xl shadow-blue-200 transition-all"
                                >
